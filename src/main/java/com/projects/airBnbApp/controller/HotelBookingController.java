...
public class HotelBookingController {
    ...
    //Here fronted call this method to check the booking status
    // This is used to check the booking status after payment is done from the backend to the User
    //This is polling endpoint, which the frontend can call to check the booking status
