...
public class BookingServiceImpl implements BookingService{
    ...
    public BookingDto initialiseBooking(BookingRequest bookingRequest) {
        ...
        //To calculate the number of days we should use, we use Chronounit beacuse we are coming dates which in thier respective format
    ...
    public boolean hasBookingExpired(Booking booking) {
        // from the current time I'm adding 10 min and its more than 10 then its experied.
        return booking.getCreatedAt().plusMinutes(10).isBefore(LocalDateTime.now());
    }

    public User getCurrentUser() {
        //this method is used to get the current user from the security context
