...
// This service handles user authentication and registration and refreshing JWT tokens.
public class AuthService {
    ...
    public String[] login(LoginDto loginDto) {
        //Here UsernamePasswordAuthenticationToken is used to authenticate the user with email and password
